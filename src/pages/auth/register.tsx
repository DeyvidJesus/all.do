            ...
            <AuthLayout>
                <div className="w-2/3">
                    ...
                    <form className="flex flex-col" onSubmit={handleSignup}>
                        ...
                        <Link href="/" className="font-bold text-gray text-md self-center mt-2 hover:underline">Already have an account? <strong className="text-dark-blue">Log in!</strong></Link>
                    </form>
                </div>
            </AuthLayout>
        </>
