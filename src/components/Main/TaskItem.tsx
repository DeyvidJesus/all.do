...
export function TaskItem({ id, name, description, deadline, initialStatus, project }: ItemProps) {
    ...
    return (
        <li className="flex items-center font-serif py-3 w-full dark:text-white justify-between">
            ...
            <div className="flex sm:flex-col items-center md:flex-row">
                <div className="flex flex-col items-center">
                    <Image className="sm:w-6 sm:h-6 lg:w-8 lg:h-8" src={calendarSrc} alt='' width={32} height={32} />
